                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 my-8 md:my-16">
                    {
                        partners?.map(partner => <div key={partner._id}
                            ...
                            <div className="text-left flex-1 flex flex-col">
                                ...
                                <p className="text-slate-400">{partner.partner_description}</p>
                            </div>
                            <figure className='flex-1 border border-slate-300 rounded-lg p-2'><img className='h-full rounded-lg' src={partner.partner_image} alt={partner.partner_name} /></figure>
                        </div>)
                    }
                </div>

                <h3 className='text-lg md:text-2xl font-bold md:leading-snug'>Together, we strive to enrich lives through the beauty of artistry and creativity.</h3>
            </div>
